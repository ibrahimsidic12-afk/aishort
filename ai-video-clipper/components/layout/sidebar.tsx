...
export function Sidebar() {
  ...
  return (
    <aside
      className={`group/sidebar relative flex flex-col border-r bg-sidebar transition-all duration-300 ${
    ...
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {/* Active indicator */}
              {isActive && (
                <div className="absolute left-0 top-1/2 h-6 w-[3px] -translate-y-1/2 rounded-r-full gradient-bg" />
              )}
      ...
      <div className="border-t p-3 space-y-2">
        ...
        >
          <span className={`shrink-0 transition-transform duration-300 ${collapsed ? "rotate-180" : ""}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-[18px] w-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
